...
public class PlayerMirrorController : NetworkBehaviour
{
    ...
    public void DestoryAllObjectInHandClients()
    {
        ...
        if (rightHand.transform.Find("ObjectHand(Clone)") != null)
        {
            Debug.LogWarning("Is Exist");
            Destroy(rightHand.transform.Find("ObjectHand(Clone)").gameObject);
        }
    }
